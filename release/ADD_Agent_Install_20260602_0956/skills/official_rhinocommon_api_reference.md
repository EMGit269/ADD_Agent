...
description: 官方 RhinoCommon API 查证 skill,请必要时才能使用。编写或修改 Grasshopper C# Script / RhinoCommon 代码时读取，尤其涉及 Rhino.Geometry、Rhino.DocObjects、RhinoDoc、图层、对象属性、材质、标注、视图、Bake、文件读写、Clipping、Display，或用户要求官方 API、RhinoCommon、C# Rhino 库、避免 API 用错时使用。
---
