...
## 自训练 skill 索引
- 2026-06-12 12:12 | `trained_做一个上海中心大厦_20260612_1212.md` | 自训练沉淀 skill。适用于类似任务：做一个上海中心大厦
- 2026-06-12 15:29 | `trained_做一个上海中心大厦_20260612_1529.md` | 自训练沉淀 skill。适用于类似任务：做一个上海中心大厦
- 2026-06-12 16:22 | `trained_做阶梯变化的体块_20260612_1622.md` | 自训练沉淀 skill。适用于类似任务：做阶梯变化的体块
- 2026-06-12 16:25 | `trained_你再观察一下对不对_20260612_1625.md` | 自训练沉淀 skill。适用于类似任务：你再观察一下对不对
- 2026-06-12 16:59 | `trained_parametric_rectangular_window_genera_20260612_1659.md` | 参数化矩形窗户生成。适用于类似任务：做一个外边缘可以吸附任何矩形形状的带框的窗户
