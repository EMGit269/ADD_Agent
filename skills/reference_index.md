...
4. 写 C# Script 且涉及 RhinoCommon API 时，读取 `skills/official_rhinocommon_api_reference.md`，先查证官方 API 再写代码。
...
## API Skills
- 描述：RhinoCommon / Grasshopper C# 官方 API 查证流程；用于避免写错 Rhino.Geometry、Rhino.DocObjects、RhinoDoc、图层、对象属性、材质、标注、视图、Bake、Clipping、Display 等 API。
